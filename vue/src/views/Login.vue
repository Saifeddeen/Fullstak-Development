...
<template>
  <div>
    <div>
      ...
      <div v-if="errorMsg" class="flex justify-between bg-red-500 w-full p-1 pl-3 mt-10 text-white rounded-md text-left">
        {{ errorMsg }}
        <span @click="errorMsg = '' " class="flex items-center justify-centet rounded transition-colors cursor-pointer hover:bg-[rgba(0,0,0,0.2)]">
