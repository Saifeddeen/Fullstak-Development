...
<template>
  <div>
    <div>
        ...
        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Register to a new account</h2>
      ...
      <form class="mt-8 space-y-6" @submit="register" method="POST">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input id="fullname" name="fname" type="text" v-model="user.name" autocomplete="email" required="" class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Full name" />
          </div>
          <div>
          ...
          <div>
            ...
            <input id="password_confirmation" name="password_confirmation" type="password" v-model="user.password_confirmation" autocomplete="current-password_confirmation" required="" class="relative block w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="password_confirmation" />
          </div>
        </div>
